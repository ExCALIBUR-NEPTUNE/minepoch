...
CONTAINS
  ...
  SUBROUTINE create_laser(boundary, laser)

    INTEGER, INTENT(IN) :: boundary
    TYPE(laser_block), POINTER, INTENT(INOUT) :: laser

    ALLOCATE(laser)
    CALL init_laser(boundary, laser)
    CALL attach_laser(laser)

  END SUBROUTINE create_laser
  ...
  SUBROUTINE laser_update_phase(laser)
    ...
    CALL custom_laser_update_phase(laser)
  ...
  SUBROUTINE laser_update_profile(laser)
    ...
    CALL custom_laser_update_profile(laser)
